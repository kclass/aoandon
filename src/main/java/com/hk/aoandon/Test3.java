...
import com.hk.aoandon.util.word.PoiWordToolsDynamic;
...
public class Test3 {
    public static void main(String[] args) throws IOException {
        final String returnurl = "D:\\barchartdynamicresult.docx";  // 结果文件
        final String templateurl = "D:\\project\\aoandon\\template\\barchartdynamic.docx";  // 模板文件
    ...
    public static void doCharts1(Map<String, POIXMLDocumentPart> chartsMap) {
        ...
        PoiWordToolsDynamic.replaceBarCharts(poixmlDocumentPart, titleArr, fldNameArr, listItemsByType);
//        PoiWordToolsDynamic.replaceLineCharts(poixmlDocumentPart, titleArr, fldNameArr, listItemsByType);
    }
}
