...
import com.hk.aoandon.util.word.PoiWordTools;
...
public class PoiDemoWordTable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final String templateurl = "D:\\project\\aoandon\\src\\main\\resources\\test.docx";  // 模板文件
    ...
    public static void doParagraphs(XWPFDocument doc) throws Exception {
        ...
        imgMap.put("img", "D:\\plan_test\\1604644059.png");
                ...
                for (XWPFRun run : runs) {
                    ...
                    if (text != null) {
                        ...
                        if (!StringUtils.isEmpty(imgMap.get(imgkey))) {
                            ...
                            try {
                                run.setText("标题1：", 0);
                                run.addPicture(new FileInputStream(imgPath), Document.PICTURE_TYPE_PNG, "img.png", Units.toEMU(410), Units.toEMU(282));
                                run.setText("标题2：");
                                run.addPicture(new FileInputStream(imgPath), Document.PICTURE_TYPE_PNG, "img.png", Units.toEMU(410), Units.toEMU(282));
                        ...
                        if (text.contains("${table1}")) {
                            ...
                            for (int i = 0; i < 10; i ++) {
                                ...
                                PoiWordTools.setWordCellSelfStyle(tableOneRowTwo.getCell(0), "微软雅黑", "9", 0, "left", "top", "#000000", "#ffffff", "10%", "一行一列");
                                PoiWordTools.setWordCellSelfStyle(tableOneRowTwo.getCell(1), "微软雅黑", "9", 0, "left", "top", "#000000", "#ffffff", "45%", "一行一列");
                                PoiWordTools.setWordCellSelfStyle(tableOneRowTwo.getCell(2), "微软雅黑", "9", 0, "left", "top", "#000000", "#ffffff", "45%", "一行一列");
                            }
...
//                            cell73.getCTTc().getTcPr().setVMerge(vmergeEnd);
    ...
    public static void doCharts(XWPFDocument doc) throws FileNotFoundException {
        ...
        for (POIXMLDocumentPart poixmlDocumentPart : relations) {
            if (poixmlDocumentPart instanceof XWPFChart) {  // 如果是图表元素
                ...
                String text = PoiWordTools.getZeroData(poixmlDocumentPart);
    ...
    public static void doCharts6(Map<String, POIXMLDocumentPart> chartsMap) {
        ...
        // 第四行数据
        Map<String, String> base4 = new HashMap<>();
        base4.put("item1", "阿拉善");
        ...
        // 第五行数据
        Map<String, String> base5 = new HashMap<>();
        ...
        // 第六行数据
        Map<String, String> base6 = new HashMap<>();
        base6.put("item1", "兴安");
        ...
        // 第七行数据
        Map<String, String> base7 = new HashMap<>();
        ...
        // 第八行数据
        Map<String, String> base8 = new HashMap<>();
        base8.put("item1", "乌海");
        ...
        // 第九行数据
        Map<String, String> base9 = new HashMap<>();
        base9.put("item1", "赤峰");
        ...
        // 第十行数据
        Map<String, String> base10 = new HashMap<>();
        base10.put("item1", "包头");
        ...
        // 第十一行数据
        Map<String, String> base11 = new HashMap<>();
        ...
        // 第十二行数据
        Map<String, String> base12 = new HashMap<>();
