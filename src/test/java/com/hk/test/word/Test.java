package com.hk.test.word;

import com.hk.test.word.util.PoiWordTools;
...
public class Test {
    public static void main(String[] args) throws Exception {
        ...
        final String returnurl = "C:\\Users\\hukai\\Desktop\\test\\result.docx";  // 结果文件

        final String templateurl = "C:\\Users\\hukai\\Desktop\\test\\test.docx";  // 模板文件
    ...
    public static void doParagraphs(XWPFDocument doc) {
        ...
        imgMap.put("img", "C:\\Users\\hukai\\Desktop\\test\\dog.jpg");
    ...
    public static void doCharts(XWPFDocument doc) {
        ...
        for (POIXMLDocumentPart poixmlDocumentPart : relations) {
            if (poixmlDocumentPart instanceof XWPFChart) {  // 如果是图表元素
                String key = PoiWordTools.getZeroData(poixmlDocumentPart);
        ...
        // 第一个图表-条形图
        POIXMLDocumentPart poixmlDocumentPart0 = chartsMap.get("chart1");
        PoiWordTools.replaceBarCharts(poixmlDocumentPart0, titleArr, fldNameArr, listItemsByType);

        // 第二个-柱状图
        POIXMLDocumentPart poixmlDocumentPart1 = chartsMap.get("chart2");
        ...
        // 第五个图表-饼图
        POIXMLDocumentPart poixmlDocumentPart4 = chartsMap.get("chart5");
    ...
    public static void doCharts3(Map<String, POIXMLDocumentPart> chartsMap) {
        ...
        POIXMLDocumentPart poixmlDocumentPart2 = chartsMap.get("chart3");
    ...
    public static void doCharts4(Map<String, POIXMLDocumentPart> chartsMap) {
        ...
        POIXMLDocumentPart poixmlDocumentPart2 = chartsMap.get("chart4");
    ...
    public static void doCharts6(Map<String, POIXMLDocumentPart> chartsMap) {
        ...
        // 下标0的图表-折线图
        POIXMLDocumentPart poixmlDocumentPart5 = chartsMap.get("chart6");
